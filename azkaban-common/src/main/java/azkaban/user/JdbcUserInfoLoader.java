...
public class JdbcUserInfoLoader extends AbstractJdbcLoader implements UserInfoLoader{
    ...
    private static class FetchAllGroupResultHandle implements
        ...
        private static String SELECT_ALL_GROUP =
                "select groupname from group_info";
    ...
    private static class FetchAllUserRoleResultHandle implements
        ...
        private static String SELECT_ALL_ROLE_RESULT =
                "select username,rolename from user_role";
    ...
    private static class FetchAllUserGroupResultHandle implements
        ...
        private static String SELECT_ALL_USER_GROUP =
                "select username,groupname from user_group";
    ...
    private static class FetchAllUserProxyResultHandle implements
        ...
        private static String SELECT_ALL_USER_PROXY =
                "select username,proxyuser from user_proxy";
    ...
    private static class FetchAllGroupRoleResultHandle implements
        ...
        private static String SELECT_ALL_GROUP_ROLE =
                "select groupname,rolename from group_role";
